...
from rl_x.algorithms.crossq2.flax.policy import get_policy
from rl_x.algorithms.crossq2.flax.critic import get_critic
from rl_x.algorithms.crossq2.flax.entropy_coefficient import EntropyCoefficient
from rl_x.algorithms.crossq2.flax.replay_buffer import ReplayBuffer
from rl_x.algorithms.crossq2.flax.rl_train_state import RLTrainState
...
class CrossQ2:
    ...
    def load(config, env, run_path, writer, explicitly_set_algorithm_params):
        ...
        model = CrossQ2(config, env, run_path, writer)
